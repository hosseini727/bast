...
namespace Raika.HomeAlarmPanel.Application.Services.DeviceHistoryServices.AddDeviceHistoryServices
{
    public class AddDeviceHistoryCommand : IRequest<AddDeviceHistoryCommandResponse>
    {
