...
{
    public class DeviceQueryRepository : QueryRepositoryBase<Device, Guid>, IDeviceQueryRepository
    {
        private readonly QueryDbContext _queryDbContext;
        public DeviceQueryRepository(QueryDbContext queryDbContext) : base(queryDbContext) => _queryDbContext = queryDbContext;
    }
}
